    ...
    function bindIO(THIS){
        ...
        function readImageFileData(file){
            ...
            if(file.type.indexOf("image") == -1){
                ...
                Polyer.UITools.Alert.show("Uploading...",true);
